...
import { supplementaryInformation } from '../lib/supplementaryInformation';
...
describe('Rendering supplementary information', () => {
  ...
  it('correctly renders supplementary information', () => {
    ...
    expect(supplementarInforamtion[1]).to.be.eql([
      { text: 'First Supplementary Information Commercial Transaction', style: 'p', colSpan: 2 }, {}, "1.0 Apples",
    ]);
